  ...
  return (
    <motion.div className='flex flex-col justify-center items-center text-center my-20'
      ...
      >
          ...
          >Generate stunning images from your imagination in seconds.</motion.p>
          ...
          >
            {Array(6).fill('').map((item,index) => (
              ...
              className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10' src={index % 2 === 0 ? assets.sample_img_1 : assets.sample_img_2} key={index} width={70} alt=""/>
            ))}
          </motion.div>
